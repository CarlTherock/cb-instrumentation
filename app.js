(() => {
  ...
  let alarmSoundInterval, vibrateInterval, torchTrack;
  ...
  function playAlarm() {
    ...
    for (let i = 0; i < 8; i++) { gain.gain.setValueAtTime(0.0001, t + i * .25); gain.gain.linearRampToValueAtTime(.9, t + i * .25 + .025); gain.gain.setValueAtTime(.9, t + i * .25 + .15); gain.gain.linearRampToValueAtTime(.0001, t + i * .25 + .19); }
